...
class FormeJuridiqueFixture extends Fixture
{
    public function load(ObjectManager $manager): void
    {
        ...
        foreach ($formeJuridiqueArray as $index => $forme) {
            $formeJuridiqueDb = new FormeJuridique();
            $formeJuridiqueDb->setLibelle($forme);
            $this->addReference($index, $formeJuridiqueDb);
            $manager->persist($formeJuridiqueDb);
        }
